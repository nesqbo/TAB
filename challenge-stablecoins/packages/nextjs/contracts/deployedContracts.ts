...
const deployedContracts = {
  ...
  11155111: {
    DEX: {
      address: "0xb167d2794906dE89900dEC2ffb0E1dbD3eE9d06F",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9936150,
    },
    MyUSD: {
      address: "0x6653E92ca21E04a3C2Ff3cBFa6e07E29416bB021",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9936149,
    },
    MyUSDEngine: {
      address: "0xdB2E2a29185006fEF728545013ff5232F9341C61",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9936153,
    },
    MyUSDStaking: {
      address: "0xF8Ac4B735355a75a30893474bFC14e73a24fF754",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9936152,
    },
    Oracle: {
      address: "0x13E0C3C222FC6e461D2981FC7b97687576195F72",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9936151,
    },
    RateController: {
      address: "0x86F4f75569172a5B8D98Df3C70D756B20CD3B77e",
      abi: [
        {
          inputs: [
            {
